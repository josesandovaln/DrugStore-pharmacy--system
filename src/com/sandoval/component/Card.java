...
public class Card extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sandoval/icon/stock.png"))); // NOI18N
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint grafic = new GradientPaint(0, 0, color1, 0, getHeight(), color2);
        g2.setPaint(grafic);
